...
![Smoker Charges](results/Medical_Charges_by_Smoking_Status.png)

### BMI vs Medical Charges
![BMI Scatter](results/bmi_vs_charges.png)

### Average Medical Cost by Region
![Region Costs](results/Average_Medical_Cost_by_Region.png)
